<template>
    <el-table :data="userList" style="width: 100%" stripe>
        ...
        <el-table-column label="操作" width="300">
            <template>
                <el-button v-if="active === 1" @click="active(id, 1)" type="text" size="small">启用</el-button>
                <el-button v-if="active === 0" @click="active(id, 0)" type="text" size="small">禁用</el-button>
